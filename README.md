Вот тебе полностью переработанный `README.md`, который учитывает **все грабли**, на которые мы с тобой наступили:
...
> ⚠️ **Важно:** Строго соблюдайте порядок команд.
> Сначала — схема (структура таблиц и триггеры), затем — данные.
